...
class AlienInvasion:
    ...
    def _check_play_button(self, mouse_pos):
        '''Проверяет нажатие кнопки Играть'''
        
        button_clicked = self.play_button.rect.collidepoint(mouse_pos)
        self.start_game(button_clicked)

    def start_game(self, event):
        '''Запускает новую игру при нажатии кнопки Играть или кнопки Enter.'''
        if event and not self.stats.game_active:
            ...
            # Создание нового флота и разаменеие корабля в центре.
            self._create_fleet()
    ...
    def _update_aliens(self):
        '''Проверяет, достиг ли флот края экрана, с последующим обновлением всех
        позиций пришельцев во влоте.'''
